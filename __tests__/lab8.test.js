describe('Basic user flow for SPA ', () => {
  ...
  it('Test4: On first Entry page - checking page header title', async () => {
    ...
    const header = await page.evaluate(el => el.innerHTML, await page.$('h1')); 
  ...
  it('Test5: On first Entry page - checking <entry-page> contents', async () => {
    ...
    const content = await entry.jsonValue(); 
    

    expect(content).toEqual(entryContent); 

  }, 10000);

  it('Test6: On first Entry page - checking <body> element classes', async () => {
    // implement test6: Clicking on the first journal entry should update the class attribute of <body> to ‘single-entry’
    const entryBody = await page.evaluate(el => el.className, await page.$('body')); 

    expect(entryBody).toBe("single-entry"); 
  });
  ...
  it('Test9: On Settings page - checking <body> element classes', async () => {
    ...
    expect(entryBody).toBe("settings"); 
  ...
  it('Test13: On home page - checking <body> element classes', async () => {
    ...
    const homeBody = await page.evaluate(el => el.className, await page.$('body'));
    

    expect(homeBody).toBe('');
  ...
  it('Test14: Clicking second <journal-entry>, new URL should contain /#entry2', async () => {
    ...
    const url = await page.url();  
    expect(await page.url()).toBe('http://127.0.0.1:5501/#entry2');
  });
  ...
  it('Test18: Clicking third <journal-entry>, new URL should contain /#entry3', async () => {
    // implement test18: Clicking on the first journal entry should update the URL to contain “/#entry3”
    await page.click('journal-entry:nth-child(3)'); 
    const url = await page.url(); 
    expect(url).toBe("http://127.0.0.1:5501/#entry3"); 
  });

  // create your own test 19
  it('Test19: On home page - checking page header title', async () => {
    // implement test19: Clicking on the home icon should update the header to be “Journal Entries”
    const header = await page.evaluate(el => el.innerHTML, await page.$('h1'));
  ...
  it('Test20: On third Entry page - checking <entry-page> contents', async () => {
    ...
    //implement test20: Clicking on the first journal entry should contain the following contents: 
      const entryContent = {
        date: "4/27/2021",
